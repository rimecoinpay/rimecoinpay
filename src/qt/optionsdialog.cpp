    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RIMECOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("RIMECOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("RIMECOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RIMECOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RIMECOIN-traditional"), QVariant("trad"));
