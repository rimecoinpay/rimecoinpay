    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rimecoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rimecoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rimecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Rimecoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RIMECOIN, 0.1 RIMECOIN, 1 RIMECOIN and 10 RIMECOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rimecoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://rimecoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rimecoin Core is shutting down...") + "<br /><br />" +
