...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RimecoinNetwork") type = RimecoinNetwork;
    if(strType == "RimecoinNetworkVariable") type = RimecoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RimecoinNetwork) s = "RimecoinNetwork";
    if(type == RimecoinNetworkVariable) s = "RimecoinNetworkVariable";
