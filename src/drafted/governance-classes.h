 ...
 *
 *   // network
 *   CRimecoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.rimecoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRimecoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CRimecoinNetwork(UniValue objIn)
    {
...
// // can be under: RimecoinNetwork
// //   -- signature requirements : Key1(User)
// class CRimecoinNetworkVariable : public CGovernanceObject
// {
// private:
