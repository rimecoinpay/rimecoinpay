...
#define BOOST_TEST_MODULE Rimecoin Test Suite

#include "test_rimecoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_rimecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
