...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Rimecoin Core rimecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rimecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rimecoin transaction") + "\n" +
              "  rimecoin-tx [options] -create [commands]   " + _("Create hex-encoded rimecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rimecoin transaction
