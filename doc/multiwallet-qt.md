...
Only requiring some minor changes is rimecoin.cpp.
...
Changes to rimecoin.cpp
----------------------
rimecoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
