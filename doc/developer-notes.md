...
Rimecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Rimecoin Core, where everyone uses
...
pay attention to for reviewers of Rimecoin Core code.

General Rimecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Rimecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
