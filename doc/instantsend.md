...
This mechanism has been integrated into Bitcore-Node-Rimecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rimecoinpay/insight-api-rimecoin#web-socket-api](https://github.com/rimecoinpay/insight-api-rimecoin#web-socket-api)
* API: [https://github.com/rimecoinpay/insight-api-rimecoin#instantsend-transactions](https://github.com/rimecoinpay/insight-api-rimecoin#instantsend-transactions)
...
By default, the Rimecoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rimecoin Core daemon:
